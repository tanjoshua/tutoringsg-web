...
export const levelOptions = [
  {
    label: "Primary",
    options: [...Object.values(PrimaryLevels)].map((level) => ({
      label: level,
      value: level,
    })),
  },
  {
    label: "Secondary",
    options: [...Object.values(SecondaryLevels)].map((level) => ({
      label: level,
      value: level,
    })),
  },
  {
    label: "JC",
    options: [...Object.values(JCLevels)].map((level) => ({
      label: level,
      value: level,
    })),
  },
